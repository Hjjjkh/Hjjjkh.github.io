...
cover: 'https://cdn.jsdelivr.net/gh/Hjjjkh/blog_images/part-2-8-cover.jpg'
abbrlink: 722abc1f
...
![二叉搜索树示例](https://cdn.jsdelivr.net/gh/Hjjjkh/blog_images/binary-search-tree-example.png)
...
![BST 插入操作](https://cdn.jsdelivr.net/gh/Hjjjkh/blog_images/bst-insertion.gif)
*图片来源: visualgo.net*
...
![BST 删除操作](https://cdn.jsdelivr.net/gh/Hjjjkh/blog_images/bst-deletion.gif)
*图片来源: visualgo.net*

**过程解析** (以删除值为 `30` 的节点为例)：
1.  **找到后继节点**：在被删除节点的**右子树**中，找到值最小的节点。在这个例子中，是 `40`。
...
![退化成链表的BST](https://cdn.jsdelivr.net/gh/Hjjjkh/blog_images/bst-degenerated-tree.png)
